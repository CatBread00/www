...
/*:
 * @plugindesc 在庫システムを有するお店を設定します。version 1.04m1
 * @author Suppon
 *
 ...
 *
 * @help
 * YEP_ShopMenuCoreプラグインと併用するときは、プラグイン管理ウインドウで、
 * このプラグインの順番をYEP_ShopMenuCoreの後に置くようにしてください。
 * また、必ずパラメータのDisplay option を true にしてください。
 *
